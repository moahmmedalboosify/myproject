...
<link href="{{ URL::asset('officepanal/assets/plugins/datatable/css/responsive.bootstrap4.min.css') }}" rel="stylesheet" />
<link href="{{ URL::asset('officepanal/assets/plugins/datatable/css/jquery.dataTables.min.css') }}" rel="stylesheet">
<link href="{{ URL::asset('officepanal/assets/plugins/datatable/css/responsive.dataTables.min.css') }}" rel="stylesheet">
<!--Internal   Notify -->
                            ...
                            @foreach ($data as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ route('office.edit.users',['id' => $user->id]) }}" class="btn btn-sm btn-info"
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('office.delete.users') }}" method="post">  
                    {{ csrf_field() }}
