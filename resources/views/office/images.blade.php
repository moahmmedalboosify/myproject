...
@section('content')
				...
				<div class="card mg-b-20" id="image1">
					<div class="card-body">
						...
						<div class="text-wrap">
							<div class="example">
								<div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}"></div>
							</div>
						</div>
...
<div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}"></div></script></code></pre>
...
<!-- End Prism Precode -->
				...
				<div class="card mg-b-20" id="image2">
					<div class="card-body">
						...
						<div class="text-wrap">
							<div class="example">
								<img alt="Responsive image" class="img-thumbnail wd-100p wd-sm-200" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}">
							</div>
						</div>
...
<img alt="Responsive image" class="img-thumbnail wd-100p wd-sm-200" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}"></script></code></pre>
							...
							<div class="text-wrap">
								<div class="example">
									<div class="bd pd-20 clearfix">
										<img alt="" class="rounded float-sm-left wd-100p wd-sm-200" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}">
										<img alt="" class="rounded float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}">
									</div>
								</div>
							</div>
						...
						<div class="text-wrap">
							<div class="example">
								<figure class="pos-relative mg-b-0 wd-sm-80p wd-md-50p">
									<img alt="Responsive image" class="img-fit-cover" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}">
