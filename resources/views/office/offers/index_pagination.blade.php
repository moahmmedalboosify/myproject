        ...
        <tbody>
            ...
            @foreach ($data as $key => $row)
                <tr>
                    ...
                    <button   id="delete_user_btn"  value="" class="btn btn-sm btn-success" title=" تغيير الحالة تم البيع"> 
                        <i class="fas fa-dollar-sign"></i></button>
                        
                     <button   id="delete_user_btn"  value="" class="btn btn-sm btn-danger" title="حذف العقار"><i
