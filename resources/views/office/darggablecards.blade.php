...
<link href="{{URL::asset('officepanal/assets/plugins/darggable/jquery-ui-darggable.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
					...
					<div class="row row-sm">
						<div class="col-xl-4 col-sm-12 col-md-6  col-lg-4">
							...
							<div class="card custom-card card-draggable">
								<img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('officepanal/assets/img/photos/1.jpg')}}">
								<div class="card-body">
						...
						<div class="col-xl-4 col-sm-12 col-md-6 col-lg-4">
							...
							<div class="card custom-card card-draggable">
								...
								<img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('officepanal/assets/img/photos/3.jpg')}}">
							</div>
						</div>
						<div class="col-xl-4 col-sm-12 col-md-12 col-lg-4">
							...
							<div class="card custom-card card-draggable">
								<img alt="Image" class="card-img img-fluid card-img-top" src="{{URL::asset('officepanal/assets/img/photos/6.jpg')}}">
...
<script src="{{URL::asset('officepanal/assets/plugins/darggable/jquery-ui-darggable.min.js')}}"></script>
<script src="{{URL::asset('officepanal/assets/plugins/darggable/darggable.js')}}"></script>
@endsection