			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{  route('show.create.offer') }}">عرض العقارات</a></li>
							<li><a class="slide-item" href="{{  route('show.create.offer') }}">أضافة عقار</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('office.show.users')}}"> عرض المستخدمين </a></li>
