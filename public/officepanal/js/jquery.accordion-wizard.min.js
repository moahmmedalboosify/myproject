!(function (a, t, e, s) {
    ...
    var n = "accWizard",
        i = {
            ...
            autoButtonsSubmitText: "حفظ",
            autoButtonsEditSubmitText: "تحديث",
            stepNumbers: !0,
            stepNumberClass: "",
    ...
    a.extend(c.prototype, {
            ...
            (this.$steps = a("[data-acc-step]")),
                ...
                this.settings.stepNumbers &&
                    this.$steps.each(function (t, e) {
                        a("[data-acc-title]", e).prepend(
                            '<span  class="acc-step-number ' +
                                i.settings.stepNumberClass +
                                '">' +
                                (t + 1) +
                                "</span> "
                        );
                    ...
                    this.$steps.each(function (t, e) {
                        ...
                        if (
                            (0 < t &&
                                s.append(
                                    '<a href="#"  class="' +
                                        i.settings.autoButtonsPrevClass +
                                        '" data-acc-btn-prev>رجوع</a>'
                                ),
                            t < i.$steps.length - 1)
                        )
                            s.append(
                                '<a href="#"  class="' +
                                    i.settings.autoButtonsNextClass +
                                    '" data-acc-btn-next>التالي</a>'
                            );
                        else if (i.settings.autoButtonsShowSubmit) {
                            var n =
                                "wizard" == i.settings.mode
                                    ? i.settings.autoButtonsSubmitText
                                    : i.settings.autoButtonsEditSubmitText;
                            s.append(
                                '<input type="submit" id="test_submit" class="' +
                                    i.settings.autoButtonsNextClass +
                                    '" value="' +
                                    n +
                                    '">'
                ...
                "wizard" == this.settings.mode
                    ? (this.activateStep(this.currentIndex, !0),
                      a("[data-acc-btn-next]").on("click", function () {
                          i.settings.beforeNextStep(i.currentIndex + 1) &&
                              i.activateStep(i.currentIndex + 1);
                      }),
                      a("[data-acc-btn-prev]").on("click", function () {
                          i.activateStep(i.currentIndex - 1);
                      }))
                    : "edit" == this.settings.mode &&
                      (this.activateAllSteps(),
                      a("[data-acc-btn-next]").hide(),
                      a("[data-acc-btn-prev]").hide()),
        ...
        activateStep: function (t, e) {           
            ...
            !e &&
                ...
                a("html").animate(
                    {
                        scrollTop:
                            this.$steps.eq(this.currentIndex).offset().top +
                            (s - this.settings.scrollPadding),
                    },
                    500
                ),
        ...
        activateAllSteps: function () {
            ...
            this.$steps.addClass("open"),
                a("[data-acc-content]", this.element).show();
        },
    }),
        (a.fn[n] = function (t) {
            return this.each(function () {
                a.data(this, "plugin_" + n) ||
                    a.data(this, "plugin_" + n, new c(this, t));
            });
        });
